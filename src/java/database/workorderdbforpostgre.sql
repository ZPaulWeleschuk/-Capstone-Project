DROP SCHEMA IF EXISTS workorderdb cascade;
CREATE SCHEMA IF NOT EXISTS workorderdb;
set search_path to workorderdb;
...
CREATE TABLE IF NOT EXISTS workorderdb.notification (
    ...
    CONSTRAINT notif_plant_FK 
        ...
        REFERENCES workorderdb.plant (plant_id),
    CONSTRAINT notif_damage_FK 
        FOREIGN KEY (damage_id) 
        REFERENCES workorderdb.damage (damage_id),
    CONSTRAINT notif_cause_FK 
        FOREIGN KEY (cause_id) 
        REFERENCES workorderdb.cause (cause_id),
    CONSTRAINT notif_tech_obj_FK 
        FOREIGN KEY (tech_obj_id) 
        REFERENCES workorderdb.technical_object (tech_obj_id));

CREATE TABLE IF NOT EXISTS workorderdb.work_order (
    work_order_id   INT NOT NULL,
    order_type  VARCHAR(4),
    description     VARCHAR(100),
    required_start_date     timestamp,
    required_end_date   timestamp,
    notification_id     INT NOT NULL,
    status      INT,
    notes       VARCHAR(250),
    ...
    CONSTRAINT order_notification_FK 
        ...
        REFERENCES workorderdb.notification (notification_id));
...
CREATE TABLE IF NOT EXISTS workorderdb.users (
    ...
    user_role    INT,
    work_center_id  VARCHAR(6),
    user_forced_reset BOOLEAN,
	user_locked BOOLEAN,
    PRIMARY KEY (user_id),
    CONSTRAINT user_work_center_FK
        FOREIGN KEY (work_center_id) 
        REFERENCES workorderdb.work_center (work_center_id));
...
ALTER TABLE workorderdb.notification 
    ADD CONSTRAINT notif_type_PK
        ...
        REFERENCES workorderdb.notif_type (type_id);

ALTER TABLE workorderdb.notification 
    ADD CONSTRAINT created_by_FK 
        FOREIGN KEY (created_by) 
        REFERENCES workorderdb.users (user_id);
...
ALTER TABLE workorderdb.operations
    ADD CONSTRAINT oper_work_order_FK 
        ...
        REFERENCES workorderdb.work_order (work_order_id);
...
INSERT INTO "users" VALUES (40099, 'Bill', 'Adams', '$argon2id$v=19$m=12,t=20,p=2$77+977+9SO+/ve+/vWPvv71477+9NO+/ve+/vX1J77+977+977+977+977+9Ru+/ve+/ve+/vUZH77+977+977+977+9UO+/vSTvv70COu+/ve+/ve+/vQfvv70$ivinMa/nncP7Jk4mpoSmnLROKe5+5eDhYr1b8Iqv3HE', 30001, NULL,false,false);
INSERT INTO "users" VALUES (40002, 'Pepe', 'Sanders', '$argon2id$v=19$m=12,t=20,p=2$77+977+9Je+/vWkG77+977+9cxUUbEojf++/ve+/vQrvv71U77+9E145CB/vv73vv73vv73vv70PUmvvv73vv70H0act77+9$9pfMGK3o5dbGwrhCOZrHiJgNK2//834oXbxeI0tOXzs', 30002, NULL,false,false);
INSERT INTO "users" VALUES (40003, 'Dana', 'White', '$argon2id$v=19$m=12,t=20,p=2$77+9f++/ve+/vSjXuAzvv71b77+9OTrvv701IgPvv71Hau+/ve+/ve+/ve+/vQNid++/vRRk77+9S++/vS0e77+9L0vvv73vv70$hCrKmC7hnPAJA33/mCzCZawc3IE4mMSP7xfQo3WZ5Ac', 30002, NULL,false,false);
INSERT INTO "users" VALUES (40004, 'Katerina', 'Marcel', '$argon2id$v=19$m=12,t=20,p=2$77+977+9Xu+/vTfvv71VUgxQOO+/vVVI77+977+977+9FHgm77+977+9ShhN77+9zb7vv70t77+9MO+/ve+/ve+/vWjIg39q17I$3fKw+RAh21biH/76ATEnYuULdBji34Laae0/UHa58lU', 30003, 'M-ELE',false,false);
INSERT INTO "users" VALUES (40005, 'Bob', 'Lamb', '$argon2id$v=19$m=12,t=20,p=2$ae+/vSRo77+977+977+9WM6e77+9N3kKVhRa77+977+9ChY977+9x67vv70I77+9US/vv70cAu+/vQEv77+9NEBA77+9EQ$eQy6sXE3WPHkxExbGOiT+nPwIHCXDhM1twrAlc8fRfY', 30003, 'M-MECH',false,false);
INSERT INTO "users" VALUES (40006, 'Elwood', 'Adler', '$argon2id$v=19$m=12,t=20,p=2$PHcW77+9D0Xvv73vv73vv71yPjPvv70g77+9Re+/ve+/vTfvv703bM+CSTMZ77+9d37vv71UR++/vWfvv71CFgUKYDc$DwVO+iYSj6tH1ir0vfKtRCOOp3mog90yd26kFlPZ1FY', 30003, 'M-EQ',false,false);
INSERT INTO "users" VALUES (40007, 'Jamie', 'Strouse', '$argon2id$v=19$m=12,t=20,p=2$77+9Pj7vv73vv73vv73vv73vv71FClI077+977+977+9WkM0RxXvv712YO+/vVdbPemqvAbvv73vv73vv73vv73vv71e77+977+977+977+9$2yO7bKdcXnzIubUUpvsZCuHH283AAOpBdo0F15eZ5y8', 30003, 'M-PM',false,false);
INSERT INTO "users" VALUES (40010, 'Arthur', 'Luna', '$argon2id$v=19$m=12,t=20,p=2$77+94q6/Be+/vULvv71877+977+977+977+9Pu+/vTLvv73Nt3IA77+977+977+977+9Lu+/vQfqlrt577+9FO+/ve+/vUtCDxgC77+9$JfuUm6aw6/Wn09gAyiXBnGHYqSfs1B10/gPfDDNOT+A', 30004, 'M-ELE',false,false);
INSERT INTO "users" VALUES (40011, 'Brad', 'Mossman', '$argon2id$v=19$m=12,t=20,p=2$77+9b++/vU7vv73vv73vv73vv70g77+977+9IC/vv73vv73vv71RGlcZ77+9ODVh77+9WO+/ve+/ve+/vRd8Oe+/ve+/vQnvv70mJu+/vS8l77+9$JaXtAwpO1pYXokyWWwkEsuyVviIov2FxPgSKk2Lxetc', 30004, 'M-ELE',false,false);
INSERT INTO "users" VALUES (40012, 'Chadwick', 'Gunther', '$argon2id$v=19$m=12,t=20,p=2$77+977+977+9PAUU77+9QwT0g66IOnjvv73vv70NQUxr2Irvv70HTlwkBnsC77+977+9fO+/vVrvv73vv70m77+9Au+/vQ$PeuNIg4kRoRU4CoJjSUMWb4OSI/OLMK6HmH8Vo6Hi3o', 30004, 'M-ELE',false,false);
INSERT INTO "users" VALUES (40013, 'Gaston', 'Vincent', '$argon2id$v=19$m=12,t=20,p=2$cRzvv73vv73vv73vv71WJe+/ve+/ve+/ve+/vXJG77+9Ye+/ve+/vXp877+9H1jvv70y77+977+9Ee+/ve+/vT1p77+9XiFYdkjvv73vv73vv70Q$V3USds42uhzNkK5EhteGIcfNyX5UR82dWZgLeLp2HUM', 30004, 'M-MECH',false,false);
INSERT INTO "users" VALUES (40018, 'Jenae', 'Rambo', '$argon2id$v=19$m=12,t=20,p=2$YVhbUlxSXDDvv70577+977+977+9z50s77+977+9Iu+/vXw3ce+/ve+/ve+/ve+/ve+/vWbvv71QJGx5PQQc77+977+9ZA$DPLVZKxh1d/NBDhpEliqK36p33+8UWCw/tNRkMWDwSY', 30004, 'M-MECH',false,false);
INSERT INTO "users" VALUES (40019, 'Alexander', 'Laque', '$argon2id$v=19$m=12,t=20,p=2$GUNhVO+/ve+/vUPvv73vv701UEXvv70A77+977+977+9KRrvv71VYnQoG++/vRHvv716G++/vRTvv71hZ++/vVjvv73vv73KpGE$y5hwTzbNmS6RmxVu5WPn78jPdMXBRmB0t7FY+fccCbc',30004, 'M-MECH',false,false);
INSERT INTO "users" VALUES (40014, 'Marina', 'Roque', '$argon2id$v=19$m=12,t=20,p=2$77+977+977+9P++/vVwf77+9bu+/ve+/vR7vv70w77+977+9F8Okd23vv71E77+9IHbvv71aEO+/vSwaL++/vRwQfe+/ve+/ve+/ve+/ve+/vQ$pZkm+EbRPFgTx2Qn4HGjgscMncnzCHAz+s38zf4htXc',30004, 'M-EQ',false,false);
INSERT INTO "users" VALUES (40015, 'Austin', 'Simons', '$argon2id$v=19$m=12,t=20,p=2$fkHvv73vv70K77+9BELvv73vv70h77+9du+/vWQM77+9Zu+/vdyc77+9X1EZ77+9OXzvv70Te++/vQJLdHPvv73vv73vv73vv70$D9tdGca1HfcWLF5nQQyUj+F7dcoY+GZA2o47s+3B5mE',30004, 'M-EQ',false,false);
INSERT INTO "users" VALUES (40020, 'Omar', 'Stewards', '$argon2id$v=19$m=12,t=20,p=2$2YEo77+9DO+/vQLvv71J77+977+9Eng877+9QGF2Z1d8cWvvv70rKO+/ve+/vVbvv70aDUPvv73vv71Y77+9Ku+/ve+/vVls$81H5k7blXvUgWVOiJxsdW7kafXj7GIMayBkY0SM+WfE',30004, 'M-EQ',false,false);
INSERT INTO "users" VALUES (40016, 'Karl', 'Bell', '$argon2id$v=19$m=12,t=20,p=2$Gk3vv71a77+977+977+9S++/vVzvv73vv71277+9dO+/vTwxQu+/vRPvv70rOgQK77+977+977+977+9dVJx77+977+9NO+/ve+/vXA1$NzbUP3q9iMuIPGK7oDfcMpp90Pw+eRrX9pvctTlfg9g',30004, 'M-PM',false,false);
INSERT INTO "users" VALUES (40017, 'Roman', 'Groot', '$argon2id$v=19$m=12,t=20,p=2$CF7vv71m77+977+9HRjvv70h77+9XsyP77+9RQwl77+9Lxvvv70GPu+/ve+/ve+/vTwJ77+977+977+9EO+/vXN877+9GXHvv70$zIVG0FCWZ8y/86w9OZWb/vVfDqavezW2UoBBV1sfwpk',30004, 'M-PM',false,false);
INSERT INTO "users" VALUES (40021, 'Javier', 'Siegmund', '$argon2id$v=19$m=12,t=20,p=2$Q++/ve+/ve+/vSzvv73vv71m77+9T++/vXIs77+9Yu+/vXY8ARLvv73vv71wMu+/ve+/ve+/ve+/vWRAwpwM77+9Au+/vXEI77+977+9$z2CwPLYzN38UDQWunKislWrQNZiWl81ywAjXR6SJFTw',30004, 'M-PM',false,false);
